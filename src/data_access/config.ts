...
export const book_data: BookData = {
    "1-ne": { volume: "bofm", n_ch: 22, names: ["1 Nephi", "1 Ne.", "1 Ne"] },
    "2-ne": { volume: "bofm", n_ch: 33, names: ["2 Nephi", "2 Ne.", "2 Ne"] },
    ...
    "w-of-m": {
        volume: "bofm",
        n_ch: 1,
        names: ["Words of Mormon", "W of M", "WoM"],
    },
    mosiah: { volume: "bofm", n_ch: 29, names: ["Mosiah"] },
    alma: { volume: "bofm", n_ch: 63, names: ["Alma"] },
    hel: { volume: "bofm", n_ch: 16, names: ["Helaman", "Hel.", "Hel"] },
    "3-ne": { volume: "bofm", n_ch: 30, names: ["3 Nephi", "3 Ne.", "3 Ne"] },
    "4-ne": { volume: "bofm", n_ch: 1, names: ["4 Nephi", "4 Ne.", "4 Ne"] },
    morm: { volume: "bofm", n_ch: 9, names: ["Mormon", "Morm.", "Morm"] },
    ether: { volume: "bofm", n_ch: 15, names: ["Ether"] },
    moro: { volume: "bofm", n_ch: 10, names: ["Moroni", "Moro.", "Moro"] },
    moses: { volume: "pgp", n_ch: 8, names: ["Moses"] },
    abr: { volume: "pgp", n_ch: 5, names: ["Abraham", "Abr.", "Abr"] },
    "js-m": {
        volume: "pgp",
        n_ch: 1,
        names: ["Joseph Smith—Matthew", "JS—M", "JSM"],
    },
    "js-h": {
        volume: "pgp",
        n_ch: 1,
        names: ["Joseph Smith—History", "JS—H", "JSH"],
    },
    "a-of-f": {
        volume: "pgp",
        n_ch: 1,
        names: ["Articles of Faith", "A of F", "AoF"],
    },
    dc: {
        volume: "dc-testament",
        n_ch: 138,
